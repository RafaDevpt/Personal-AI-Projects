...
PT-PT: Particularidades do Windows.
       ...
       Esta é a versão para Windows do PDF Suite. Não há aqui nenhuma
...
EN-UK: Windows specifics.
       ...
       This is the Windows version of PDF Suite. There is no operating-system
...
def check_requirements() -> list[Requirement]:
    ...
    return [
        ...
        Requirement(
            ...
            command=install_command("poppler"),
        ),
    ]
