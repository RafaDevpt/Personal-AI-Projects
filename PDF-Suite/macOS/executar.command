#!/usr/bin/env bash
# ===========================================================================
# PT-PT: Arranque do PDF Suite em macOS.
#
...
#
# EN-UK: PDF Suite launcher for macOS.
#
...
if ! command -v pdftoppm >/dev/null 2>&1; then
    aviso "O poppler nao esta instalado: o editor visual de campos abre em modo de lista."
    passo "brew install poppler"
    passo "tudo o resto funciona na mesma"
fi
