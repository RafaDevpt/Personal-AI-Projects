...
#          ./cli.sh --diagnostico
#
#        Para agendar, o launchd e o caminho certo em macOS — não o cron, que
#        ainda existe mas esta a prazo. Há um exemplo de .plist no LEIA-ME
#        desta pasta.
#
...
# PT-PT: O launchd arranca com um PATH mínimo que não inclui o Homebrew, por
#        isso o FFmpeg tem de ser encontrado explicitamente. Sem esta linha, a
#        tarefa agendada falha todas as noites com "FFmpeg não encontrado"
