...
PT-PT: Sobre as cores. O índigo e o acento da interface e as gravidades tem uma
       cor cada. O vermelho fica reservado ao crítico — se aparecer em botões ou
       títulos, deixa de saltar a vista quando aparece num disco a falhar. A
       v1.0 usava vermelho no título de cada separador e o resultado era
       previsível: ninguém reparava nos alertas.
...
# PT-PT: Uma cor por gravidade. O vermelho não é usado em mais nada.
...
# PT-PT: Monoespaçado para saídas de comandos, Event IDs e endereços. A saída do
#        ipconfig ou do tracert vem alinhada por espaços: numa proporcional as
