...
class ITToolkitApp(ctk.CTk):
    ...
    def _barra_lateral(self) -> None:
        ...
        # PT-PT: As duas permissões aparecem juntas de propósito. Num Mac são
        #        independentes, e um operador que veja «root» assume que vê tudo
        #        — pode estar a correr como root sem Acesso Total ao Disco, e
        #        nesse caso metade do diário e todos os relatórios de paragem do
        #        sistema estão invisiveis sem um único erro no ecrã.
    ...
    def _pagina_ferramentas(self, pagina: ctk.CTkFrame, etiqueta: str) -> None:
        ...
        # PT-PT: Quase todos estes utilitários fazem parte do macOS, mas nem
        #        todos sobrevivem a todas as versões — o Utilitario de Rede
        #        desapareceu no macOS 11. Um botão que não abre nada é pior do
    ...
    def analisar_eventos(self) -> None:
        """PT-PT: Só o diário. / EN-UK: The log only."""
        config = self.config_app
        ...
        #        que não saiba disso carrega no botão outra vez.
    ...
    def _receber_servicos(self, lista) -> None:
        ...
        #        serviços, ou o texto de um registo. Aceitar as duas aqui evita
    ...
    def registo_servico(self) -> None:
        """PT-PT: Últimas mensagens do diário de um serviço.
