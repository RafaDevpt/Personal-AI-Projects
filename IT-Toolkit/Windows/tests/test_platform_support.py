...
EN-UK: Windows specifics tests, in the Windows version of IT Toolkit.
...
from ittoolkit.config import APP_FOLDER_NAME
from ittoolkit.config import default_data_dir as caminho_de_configuracao
