...
PT-PT: Particularidades do Linux.
       ...
       Esta e a versao para Linux do Network Config Builder. Nao ha aqui nenhuma
...
EN-UK: Linux specifics.
       ...
       This is the Linux version of Network Config Builder. There is no operating-system
