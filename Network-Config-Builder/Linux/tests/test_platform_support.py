...
EN-UK: Linux specifics tests, in the Linux version of Network Config Builder.
...
from netconfig import platform_support as ps
from netconfig.config import APP_FOLDER_NAME
from netconfig.config import app_data_dir as caminho_de_configuracao
from netconfig.platform_support import Distro
