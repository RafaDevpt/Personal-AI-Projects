...
PT-PT: Particularidades do Windows.
       ...
       Esta e a versao para Windows do Network Config Builder. Nao ha aqui nenhuma
...
EN-UK: Windows specifics.
       ...
       This is the Windows version of Network Config Builder. There is no operating-system
