...
PT-PT: Particularidades do macOS.
       ...
       Esta e a versao para macOS do Network Config Builder. Nao ha aqui nenhuma
...
EN-UK: macOS specifics.
       ...
       This is the macOS version of Network Config Builder. There is no operating-system
