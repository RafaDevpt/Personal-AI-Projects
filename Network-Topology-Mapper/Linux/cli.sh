#!/usr/bin/env bash
# ===========================================================================
# PT-PT: Modo sem interface do Network Topology Mapper, em Linux.
#
#          ./cli.sh --help
#
...
#
# EN-UK: Network Topology Mapper headless mode on Linux. It does not prepare the
