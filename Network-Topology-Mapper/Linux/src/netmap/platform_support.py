...
PT-PT: Particularidades do Linux.
       ...
       Esta e a versao para Linux do Network Topology Mapper. Nao ha aqui nenhuma
...
EN-UK: Linux specifics.
       ...
       This is the Linux version of Network Topology Mapper. There is no operating-system
