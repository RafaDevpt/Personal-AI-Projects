...
EN-UK: Linux specifics tests, in the Linux version of Network Topology Mapper.
...
from netmap import platform_support as ps
from netmap.config import APP_FOLDER_NAME
from netmap.config import app_data_dir as caminho_de_configuracao
from netmap.platform_support import Distro
