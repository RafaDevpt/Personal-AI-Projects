...
PT-PT: Particularidades do Windows.
       ...
       Esta e a versao para Windows do Network Topology Mapper. Nao ha aqui nenhuma
...
EN-UK: Windows specifics.
       ...
       This is the Windows version of Network Topology Mapper. There is no operating-system
