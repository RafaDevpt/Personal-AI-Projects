...
PT-PT: Particularidades do macOS.
       ...
       Esta e a versao para macOS do Network Topology Mapper. Nao ha aqui nenhuma
...
EN-UK: macOS specifics.
       ...
       This is the macOS version of Network Topology Mapper. There is no operating-system
